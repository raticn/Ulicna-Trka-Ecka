...
<template>
    <div class="trka4Wrapper">
        ...
        <h2 class="trka4Header">{{ this.shortText.trka5Info }}</h2>
        <!-- <p class="trka4Rez">
            {{ this.shortText.trka4Rez }}: <a href="https://trka.rs/events/698-5-ulicna-trka-ecka/" target="_blank" aria-label="Link do naše Facebook stranice"> trka.rs/events/479/</a>
        </p> -->
        <div class="propozicijeWrapper">
            <!-- <h3 class="trka4SubHeader">{{ this.shortText.propNaslov }}</h3> -->
            <p>{{ this.shortText.propP21 }}</p>
            <p>{{ this.shortText.propP22 }} <span class="bold">{{ this.shortText.propP23 }}</span></p>
            <p>{{ this.shortText.propP24 }} <span class="bold">{{ this.shortText.propP3 }}</span></p>
            <p>{{ this.shortText.propP25 }} <span class="bold">{{ this.shortText.propP5 }}</span></p>
            <p>{{ this.shortText.propP26 }}</p>
            <p>{{ this.longText.propP27 }}</p>
            <p>{{ this.longText.propP28 }} <a href="https://trka.rs/events/698-5-ulicna-trka-ecka/">{{ this.shortText.propP9 }}</a> {{ this.shortText.propP29 }}</p>
            <p>{{ this.shortText.propP30 }} <a href="https://trka.rs/events/698-5-ulicna-trka-ecka/">{{ this.shortText.propP9 }}</a> {{ this.shortText.propP31 }}</p>
        ...
        <div class="kategorijeWrapper">
            ...
            <div class="podelaKategorija">
                ...
                <img src="https://093g123.mars2.mars-hosting.com/API/pictures/115" alt="Slika pehara i medalja">
            </div>
            ...
            <div id="carouselExampleCaptions5" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="5000">
                        <img src="https://093g123.mars2.mars-hosting.com/API/pictures/116" class="d-block w-100" alt="Ulicna trka Ecka slike">
                    </div>
